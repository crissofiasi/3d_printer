...
#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define AUTO_BED_LEVELING_GRID_POINTS 3
      ...
      #define ABL_PROBE_PT_1_Y 137
      #define ABL_PROBE_PT_2_X 191
      #define ABL_PROBE_PT_2_Y 137
      #define ABL_PROBE_PT_3_X 94
      #define ABL_PROBE_PT_3_Y 17

  #endif // AUTO_BED_LEVELING_GRID

  // Offsets to the probe relative to the extruder tip (Hotend - Probe)
  // X and Y offsets must be integers
  #define X_PROBE_OFFSET_FROM_EXTRUDER 74     // Probe on: -left  +right
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
  ...
  #define Z_SAFE_HOMING   // This feature is meant to avoid Z homing with probe outside the bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT 20 //(X_MAX_LENGTH/2)    // X point for Z homing when homing all axis (G28)
    #define Z_SAFE_HOMING_Y_POINT 137 //(Y_MAX_LENGTH/2)    // Y point for Z homing when homing all axis (G28)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,700}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 15, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1500,1500,150,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
